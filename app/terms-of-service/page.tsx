...
export const metadata: Metadata = {
  ...
  description: "EuroBrico terms and conditions for using our services.",
};
          ...
          <div className="prose prose-gray max-w-none space-y-8">
            <div>
              ...
              <p className="text-gray-600">
                By accessing or using EuroBrico&apos;s website and services, you agree to be bound by these Terms of Service. If you disagree with any part, you may not access our services.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600">
                EuroBrico Ltd provides wholesale electronics and tech gadgets. All products are subject to availability. We reserve the right to modify or discontinue products without notice. Prices are subject to change.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600">
                EuroBrico Ltd shall not be liable for any indirect, incidental, or consequential damages arising from use of our products or services. Our total liability shall not exceed the amount paid for the specific product or service.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600">
                All content on this website, including text, graphics, logos, and images, is the property of EuroBrico Ltd and protected by intellectual property laws. Unauthorised use is prohibited.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600">
                EuroBrico Ltd<br />
                78 Commerce Street, Manchester, M2 4WQ<br />
                United Kingdom<br />
                Email: info@eurobricostore.com<br />
                VAT: IT 04829371056<br />
