  ...
  return (
    <div className="bg-black text-white py-3 px-4">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-center gap-2 md:gap-4 text-center">
        ...
        <div className="flex items-center gap-2">
          <span className="text-sm text-gray-300">Ponudba se konča čez:</span>
...
const LiveViewers = () => {
  ...
  return (
    <div className="flex items-center gap-2 text-sm text-gray-600 bg-gray-100 rounded-lg px-3 py-2">
      ...
      <span><strong className="text-black">{Math.max(15, viewers)}</strong> ljudi si trenutno ogleduje ta izdelek</span>
    </div>
  );
};
        ...
        <div className="order-2 space-y-4">
          <div className="space-y-2">
            ...
            <h1 className="text-[28px] md:text-4xl font-black leading-tight uppercase tracking-tight text-gray-900">
              ...
              <span className="text-orange-600">Dvojna Streha + 4 Stranske Stene</span>
            </h1>

            <p className="text-[17px] md:text-lg text-gray-600 leading-relaxed">
              Premium jeklena konstrukcija, vodotesna ponjava z UV zaščito in snemljive stranske stene vključene v ceni.
            </p>
          </div>
          ...
          <ul className="space-y-2.5">
            {[
              { icon: Ruler, text: "3x3 Metre — Prostor za 8-10 oseb" },
              { icon: Layers, text: "Dvojna Prezračevalna Streha — Hladno tudi pri 40°C" },
              { icon: Droplets, text: "100% Vodotesno — Popolna zaščita" },
              { icon: Wind, text: "4 Stranske Stene Vključene" },
            ].map((item, i) => (
          ...
          <div id="objednat">
            ...
            >
              <ShoppingBag size={24} />
              NAROČITE — PLAČILO OB DOSTAVI
            </button>
            <div className="flex items-center justify-center gap-2 mt-2 text-sm text-gray-500">
              <Lock size={14} />
              <span>Varno plačilo z gotovino ob dostavi</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-2">
            <div className="bg-gray-100 p-3 rounded-xl text-center">
              ...
              <p className="text-[11px] font-bold text-gray-700">Dostava<br />BREZPLAČNO</p>
            </div>
            <div className="bg-gray-100 p-3 rounded-xl text-center">
    ...
    <div className="max-w-5xl mx-auto">
      <div className="text-center mb-10">
        <h2 className="text-[22px] md:text-4xl font-black uppercase tracking-tight leading-tight">
          Ste Naveličani Sedenja Doma Poleti?
        </h2>
      </div>
        ...
        <div className="bg-white p-5 md:p-6 rounded-2xl border border-gray-200 shadow-sm">
          ...
          <ul className="space-y-3">
            {[
              ...
              "Nepričakovane nevihte pokvarijo praznovanja in žar",
        ...
        <div className="bg-white p-5 md:p-6 rounded-2xl border-2 border-orange-300 shadow-sm">
          ...
          <ul className="space-y-3">
            {[
              ...
              "Zasebnost zahvaljujoč stranskim stenam",
              "Uživajte v vrtu vse leto",
            ].map((item, i) => (
              <li key={i} className="flex items-start gap-3 text-[15px] md:text-base">
  ...
  const features = [
    {
      ...
      desc: "Do 10°C hladneje kot v običnih paviljonih.",
      img: "/images/gazebo/1.jpg",
    },
    {
      title: "Vodotesna Ponjava",
      desc: "Poliester 180g/m² s PU premazom. 100% vodotesno.",
      img: "/images/gazebo/2.jpg",
    },
    {
      title: "Premium Jeklo",
      desc: "Praškasto lakirano proti rji. Vzdrži veter do 50 km/h.",
      img: "/images/gazebo/3.jpg",
    },
    {
      title: "4 Stene Vključene",
    ...
    },
    {
      ...
      desc: "Bež barva, ki se ujema z vsako vrtno ureditvijo.",
      ...
      <div className="bg-gray-800 rounded-2xl p-5 md:p-6">
        <div className="grid grid-cols-2 gap-4 md:gap-5">
          {[
            ...
            { label: "Konstrukcija", value: "Lakirano jeklo" },
            { label: "Ponjava", value: "Poliester 180g/m²" },
            { label: "Vodotesnost", value: "100%" },
            { label: "UV Zaščita", value: "UPF 50+" },
            { label: "Kapaciteta", value: "8-10 oseb" },
            { label: "Stranske Stene", value: "4 vključene" },
          ].map((spec, i) => (
...
const reviewData = [
  { batch: 1, av: "M", name: "Marko B.", city: "Ljubljana", stars: 5, text: "Postavil sem ga v 40 minutah z ženo. Neverjetna kakovost za to ceno, mislil sem, da bom dobil poceni materiale, a je konstrukcija res trdna. Dvojna streha je genialna!" },
  { batch: 1, av: "J", name: "Jana S.", city: "Maribor", stars: 5, text: "Že preživel dve močni nevihti brez ene same kaplje vode. Stranske stene so super praktične, ko so sosedje v vrtu. Toplo priporočam!" },
  { batch: 1, av: "P", name: "Peter F.", city: "Celje", stars: 5, text: "Za 99€ je to darilo! Videl sem ga v trgovini skoraj za dvojno ceno. Prišel je v 2 dneh, montaža enostavna. Zdaj vedno kosimo pod paviljonom." },
  { batch: 2, av: "L", name: "Lucija R.", city: "Kranj", stars: 5, text: "Imeli smo sinov rojstni dan pod paviljonom. 15 otrok varnih pred soncem! Stabilna konstrukcija, elegantna barva, ki se ujema z našim vrtom." },
  { batch: 2, av: "T", name: "Tomaž D.", city: "Koper", stars: 5, text: "Iskal sem paviljon s stranskimi stenami v ceni, drugje jih prodajajo posebej za 50€ več. Tukaj je bilo vse v ceni. Premium kakovost!" },
  { batch: 2, av: "K", name: "Katarina M.", city: "Nova Gorica", stars: 5, text: "Dvojna streha res naredi razliko. Vedno je svež zrak tudi ob 14. uri. Postavljeno v manj kot eni uri, rezultat je spektakularen!" },
  { batch: 3, av: "R", name: "Robert C.", city: "Novo Mesto", stars: 5, text: "Tretji paviljon, ki ga kupujem v 5 letih, prva dva sem vrgel po eni sezoni. Ta izgleda, da bo zdržal: močno jeklo, odporna ponjava, popolni šivi." },
  { batch: 3, av: "E", name: "Eva L.", city: "Velenje", stars: 5, text: "Uporabljam ga kot kotiček za branje in jutranjo kavo. S spuščenimi stenami je to moj mali raj. Odlično razmerje med ceno in kakovostjo!" },
  { batch: 3, av: "D", name: "David P.", city: "Ptuj", stars: 5, text: "Dvomil sem zaradi nizke cene, naročil sem pripravljen na vračilo. A se je zmotil: top kakovost, hitra dostava, enostavna montaža. 5 zvezdic zasluženih." },
  { batch: 4, av: "V", name: "Vesna T.", city: "Trbovlje", stars: 5, text: "Končno lahko zajtrkovam v vrtu brez umiranja od vročine! Paviljon je prišel dobro zapakiran, noben del poškodovan. Toplo priporočam." },
  { batch: 4, av: "O", name: "Oskar M.", city: "Piran", stars: 5, text: "Kupil sem ga za nedeljski žar. Že preživel 3 poletne nevihte brez problemov. Moji prijatelji so bili navdušeni nad kakovostjo." },
  { batch: 4, av: "A", name: "Ana G.", city: "Domžale", stars: 5, text: "Pri nas je poleti sonce zelo močno. Dvojna streha ohranja prostor hladen. Stranske stene popolne za zasebnost. Odličen nakup!" },
  { batch: 5, av: "F", name: "Filip F.", city: "Kamnik", stars: 5, text: "Postavil sem paviljon sam v približno 50 minutah po navodilih. Stabilna konstrukcija, kakovostna ponjava. Za to ceno ni boljšega." },
  { batch: 5, av: "I", name: "Irena R.", city: "Jesenice", stars: 4, text: "Odličen izdelek, le navodila bi lahko bila jasnejša. A na koncu vse popolnoma postavljeno. Paviljon je čudovit in funkcionalen." },
  { batch: 5, av: "H", name: "Hugo B.", city: "Škofja Loka", stars: 5, text: "Kupil sem ga za hčerino poroko v vrtu. Eleganten, prostoren, zaščitil goste pred julijskim soncem. Denar zelo dobro vložen!" },
  { batch: 6, av: "B", name: "Barbara C.", city: "Izola", stars: 5, text: "Uporabljam ga vsak dan za delo na računalniku zunaj. Z WiFi-jem in paviljonom imam svojo pisarno v vrtu. Genialno!" },
  { batch: 6, av: "G", name: "Gašper L.", city: "Postojna", stars: 5, text: "Iskal sem nekaj trdnega, kar bo zdržalo. Po 6 mesecih intenzivne uporabe lahko rečem, da je to odličen izdelek. Nobenih problemov." },
  { batch: 6, av: "N", name: "Nataša V.", city: "Murska Sobota", stars: 5, text: "Plačilo ob dostavi zelo praktično, nobeno tveganje. Kurir je bil točen. Paviljon je točno tak kot na slikah, pravzaprav še boljši!" },
  { batch: 7, av: "U", name: "Urban Z.", city: "Slovenj Gradec", stars: 5, text: "Fantastično! Uporabljam ga za večerje zunaj s prijatelji. Kakovost je res vrhunska, ponjava izgleda zelo vzdržljiva. Odličen nakup!" },
  { batch: 7, av: "Z", name: "Zala N.", city: "Logatec", stars: 5, text: "Moj stari paviljon se je zlomil po enem letu. Ta izgleda veliko bolj trden. Stranske stene so neverjeten bonus za to ceno." },
  { batch: 7, av: "C", name: "Ciril S.", city: "Ravne na Koroškem", stars: 5, text: "Popoln za naš vrt! Montaža zelo enostavna, v dvoje sva potrebovala pol ure. Bež barva je elegantna in se ujema z vsem." },
  { batch: 8, av: "W", name: "Vladimir M.", city: "Bled", stars: 5, text: "Pri nas je poleti zelo vroče. Dvojna streha ohranja prostor hladen! Hitra dostava in izdelek ustreza opisu." },
  { batch: 8, av: "X", name: "Kristina P.", city: "Ajdovščina", stars: 5, text: "Primerjala sem veliko paviljonov na spletu, ta je imel najboljše razmerje med kakovostjo in ceno. Nisem bila razočarana, ravno nasprotno! Trdna in lepa konstrukcija." },
  { batch: 8, av: "Y", name: "Jakob C.", city: "Radovljica", stars: 5, text: "Uporabljam ga tudi pozimi za zaščito vrtnega pohištva. 100% vodotesen, testiral sem pri močnem dežju. Nobeno puščanje!" },
  { batch: 9, av: "S", name: "Sonja A.", city: "Tržič", stars: 5, text: "Kupila sem ga za poletje, postal je center naših vrtnih večerov. Prijatelji vedno sprašujejo, kje sem ga dobila. Super zadovoljna!" },
  { batch: 9, av: "Q", name: "Karel D.", city: "Krško", stars: 4, text: "Dober izdelek na splošno. Le želel bi si, da bi bile na voljo različne barve. Ampak kakovost je odlična za plačano ceno." },
  { batch: 9, av: "AA", name: "Anton V.", city: "Brežice", stars: 5, text: "Okleval sem s plačilom ob dostavi, a je bilo vse popolno. Paviljon je prišel cel in dobro zapakiran. Priporočam!" },
  { batch: 10, av: "AB", name: "Blanka F.", city: "Litija", stars: 5, text: "Končno paviljon, ki ne odleti ob prvem vetru! Konstrukcija je trdna in stene dobro ščitijo. Zelo zadovoljna z nakupom." },
  { batch: 10, av: "AC", name: "Črt E.", city: "Vrhnika", stars: 5, text: "Postavil sem ga za krst nečaka. Vsi gosti so bili navdušeni. Estetsko čudovit in zelo funkcionalen." },
  { batch: 10, av: "AD", name: "Darja L.", city: "Žalec", stars: 5, text: "Po dolgem iskanju sem izbrala tega in ne obžalujem. Cena je neprekosljiva za ponujeno kakovost. Hitra dostava!" },
];
...
const QuickOrderForm = () => {
  ...
  const validate = (): boolean => {
    ...
    if (!form.address.trim()) errs.address = "Vnesite celoten naslov";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      localStorage.setItem("gazebo-sl-order", JSON.stringify({
    ...
    try {
      ...
      window.location.href = "/ty/gazebo-sl";
    } catch (err: unknown) {
      ...
      <div className="max-w-lg mx-auto">
        <div className="text-center text-white mb-6">
          ...
          <p className="text-white/90 text-[15px] md:text-base">
            Dostava BREZPLAČNO • Dobava 24-48h
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl p-5 md:p-6 shadow-2xl space-y-4">
          ...
          <div>
            <label className="block text-[15px] md:text-base font-bold text-gray-700 mb-1.5">Celoten Naslov *</label>
            <input
              type="text"
          ...
          >
            {submitting ? (
              ...
              <>
                <ShoppingBag size={22} />
                POTRDITE NAROČILO — 99€ OB DOSTAVI
              </>
            )}
          </button>
          ...
          <div className="flex items-center justify-center gap-2 text-[14px] md:text-[15px] text-gray-500 pt-2">
            ...
            <span><strong className="text-green-600">VARNO</strong> plačilo z gotovino ob dostavi</span>
          </div>

          <div className="flex items-center justify-center gap-4 text-[13px] md:text-sm text-gray-400 pt-2">
            <span className="flex items-center gap-1"><Truck size={14} /> Dostava Brezplačno</span>
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-3 gap-3 md:gap-4 mb-10">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 md:p-5 text-center border border-white/20">
            ...
            <div className="text-[11px] md:text-sm font-bold text-gray-300 uppercase tracking-wide">Kosov Preostaja</div>
          </div>
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 md:p-5 text-center border border-white/20">
        ...
        <div className="space-y-4 mb-10">
          <div className="bg-red-900/50 border-2 border-red-500 rounded-xl p-4 md:p-5">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="font-black text-base md:text-lg mb-1">Zaloge Se Zmanjšujejo</h4>
                <p className="text-gray-300 text-[14px] md:text-[15px] leading-relaxed">
                  Ta serija za <strong className="text-white">99€</strong> je skoraj razprodana. Naslednje naročilo pri dobavitelju bo dražje in cena se bo vrnila na <strong className="text-white">219€</strong>. Te cene ne moremo zagotoviti jutri.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-orange-900/50 border-2 border-orange-500 rounded-xl p-4 md:p-5">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-300 text-[14px] md:text-[15px] leading-relaxed">
                  Običajno dostava stane <strong className="text-white">14,90€</strong> za tako velik paket. Danes jo ponujamo <strong className="text-white">BREZPLAČNO</strong> kot spodbudo za razprodajo skladišča. Ta akcija se lahko konča ob polnoči.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-gradient-to-r from-gray-900 to-gray-800 rounded-2xl p-5 md:p-6 mb-10 border border-gray-700">
          <h3 className="text-lg md:text-xl font-black text-center mb-6 uppercase">Ko Naročite Danes vs Ko Počakate</h3>
          <div className="grid grid-cols-2 gap-4 md:gap-6">
            <div className="space-y-3">
              ...
              <ul className="space-y-2.5 text-[13px] md:text-sm">
                ...
                <li className="flex items-center gap-2"><CheckCircle2 size={16} className="text-green-500 flex-shrink-0" /> Dostava BREZPLAČNO</li>
                <li className="flex items-center gap-2"><CheckCircle2 size={16} className="text-green-500 flex-shrink-0" /> Dobava 24-48h</li>
                <li className="flex items-center gap-2"><CheckCircle2 size={16} className="text-green-500 flex-shrink-0" /> Pripravljeni na poletje</li>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2 text-red-400 font-bold text-sm md:text-base">
                <XCircle size={20} />
                <span>KO POČAKATE</span>
              </div>
              <ul className="space-y-2.5 text-[13px] md:text-sm text-gray-400">
                <li className="flex items-center gap-2"><XCircle size={16} className="text-red-500 flex-shrink-0" /> Plačate 219€</li>
                ...
                <li className="flex items-center gap-2"><XCircle size={16} className="text-red-500 flex-shrink-0" /> Zamudite polovico poletja</li>
                <li className="flex items-center gap-2"><XCircle size={16} className="text-red-500 flex-shrink-0" /> Noben prihranek</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="text-center">
          ...
          >
            <ShoppingBag size={24} />
            DA, ŽELIM SVOJ PAVILJON ZA 99€
          </button>
          <p className="text-gray-500 text-xs md:text-sm mt-3">
            Kliknite na gumb in izpolnite obrazec — traja le 30 sekund
          </p>
        </div>
      </div>
    </section>
  ...
  const faqs = [
    {
      ...
      a: "30-45 minut z 2 osebama. Jasna navodila in orodje v paketu."
    },
    {
      q: "Je odporen proti dežju?",
      a: "Da, ponjava je 100% vodotesna s PU premazom."
    },
    {
      q: "So stene vključene?",
      a: "Da! Vse 4 stranske stene so vključene v ceni 99€."
    },
    {
      q: "Kako plačam?",
      a: "Plačate z gotovino kurirju ob prevzemu paketa. Nobeno vnaprejšnje plačilo."
    },
  ];
  ...
  <footer className="bg-gray-900 text-white py-10 px-4">
    <div className="max-w-7xl mx-auto text-center space-y-6">
      ...
      <div className="flex flex-wrap justify-center gap-6 text-xs font-bold uppercase text-gray-500 tracking-wide">
        <a href="/privacy-policy" className="hover:text-white transition-colors">Varstvo Zasebnosti</a>
        <a href="/terms-of-service" className="hover:text-white transition-colors">Pogoji Uporabe</a>
