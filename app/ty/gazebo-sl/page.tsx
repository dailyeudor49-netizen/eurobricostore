...
export default function GazeboSlThankYou() {
  ...
  useEffect(() => {
    const storedData = localStorage.getItem('gazebo-sl-order');
    if (storedData) {
      try {
        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-gray-600 mb-2">
              Hvala{orderData.fullName ? `, ${orderData.fullName.split(' ')[0]}` : ''}! Vaše naročilo je bilo sprejeto.
            </p>
            ...
            <div className="p-6 md:p-8 border-b border-gray-100">
              <div className="flex gap-4 md:gap-6">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-500 text-sm mb-3">Dvojna Streha + 4 Stranske Stene</p>
            ...
            <div className="p-6 md:p-8 bg-gray-50 space-y-4">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">{orderData.address || 'Naslov naveden'}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="font-bold text-gray-900 text-sm uppercase tracking-wide mb-1">Pričakovana Dostava</p>
                  <p className="text-gray-600 capitalize">{formattedDate}</p>
                  <p className="text-green-600 font-bold text-sm mt-1">Dostava BREZPLAČNO</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Povzetje - Plačilo ob dostavi</p>
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <div>
                <h3 className="font-bold text-gray-900 mb-1">Potrditev prek SMS</h3>
                <p className="text-gray-600 text-sm">
                  Prejeli boste SMS potrditev na številko {orderData.phone || 'navedeno'} s podrobnostmi naročila.
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Vaš paviljon bo pripravljen in poslan v 24 urah z ekspresno kurirsko službo.
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Kurir vas bo kontaktiral pred dostavo. Plačali boste 99€ z gotovino ob prevzemu.
                </p>
              </div>
            </motion.div>
          </div>
        ...
        <div className="max-w-2xl mx-auto">
          <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-3xl p-6 md:p-8 text-white text-center">
            ...
            <p className="text-gray-400 mb-4 text-sm md:text-base">
              Naša podpora strankam je na voljo od ponedeljka do petka, 9:00 - 18:00
            </p>
            <a
              href="tel:+386123456789"
        ...
        <div className="max-w-2xl mx-auto">
          <div className="bg-gradient-to-r from-yellow-400 to-orange-400 rounded-3xl p-6 md:p-8 text-center">
            ...
            <p className="text-white/90 mb-4 text-sm md:text-base">
              Ob vašem naročilu prejmete <strong>BREZPLAČNO</strong> dodaten komplet klinom za pritrditev na mehki podlagi!
            </p>
            <div className="inline-block bg-white/20 backdrop-blur-sm rounded-xl px-4 py-2">
              <span className="text-white font-bold">Vrednost: 19,90€ — BREZPLAČNO</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-gray-900 text-white py-10 px-4">
        <div className="max-w-7xl mx-auto text-center space-y-6">
          ...
          <div className="flex flex-wrap justify-center gap-6 text-xs font-bold uppercase text-gray-500 tracking-wide">
            <Link href="/privacy-policy" className="hover:text-white transition-colors">Varstvo Zasebnosti</Link>
            <Link href="/terms-of-service" className="hover:text-white transition-colors">Pogoji Uporabe</Link>
